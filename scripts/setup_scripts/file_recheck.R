file_recheck <- function(){
	cat(blue$bgWhite$bold("[ ] Begining the second round file checking") %+% black$bgWhite$bold(" Begining the second round file checking") %+% "\n")
	...
	cat(green$bgWhite$bold("[+]") %+% black$bgWhite$bold(" Second round file checking finished") %+% "\n")
}